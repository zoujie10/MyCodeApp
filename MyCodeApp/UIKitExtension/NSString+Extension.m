...
@end
@implementation NSString (ZJ_StringFormat)

+ (instancetype)ZJ_stringWithNSInteger:(NSInteger)integerValue {
    return [NSString stringWithFormat:@"%@", @(integerValue)];
}

+ (instancetype)ZJ_stringWithCGFloat:(CGFloat)floatValue {
    return [NSString ZJ_stringWithCGFloat:floatValue decimal:2];
}

+ (instancetype)ZJ_stringWithCGFloat:(CGFloat)floatValue decimal:(NSUInteger)decimal {
